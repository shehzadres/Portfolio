...
export const projects: Project[] = [
  /* ── 01 · Visual Regex Builder ──────────────────────────── */
  {
    ...
    architecture: [
      ...
      "Thompson construction converts the AST to an NFA; subset construction converts the NFA to a DFA; Hopcroft's algorithm minimizes the DFA, with each step visualized as a live D3 automata diagram.",
  ...
  /* ── 03 · P2P Encrypted File Transfer (Nexus) ───────────── */
  {
    ...
    features: [
      "Files travel directly browser-to-browser over WebRTC DataChannels, with zero bytes stored on the server.",
  ...
  /* ── 05 · WebGL Data Globe ───────────────────────────────── */
  {
    ...
    year: null,
    summary:
      "A production-quality interactive 3D globe built with React, Three.js, and custom GLSL shaders for a cinematic, scroll-driven storytelling experience with geospatial data, flight-route animation, particle systems, and a fully custom camera engine.",
    problem:
