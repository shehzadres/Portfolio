...
const SITE_DESCRIPTION =
  "Portfolio of Shahzad, a software engineer specialising in real-time collaboration, applied cryptography, WebGL data visualisation, and production-grade full-stack systems.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#e8eaf0" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,700;1,9..40,400&family=DM+Mono:wght@300;400;500&display=swap",
      },
    ],
  }),
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Prevent FOUC: default to light; respect saved preference */}
        <script
